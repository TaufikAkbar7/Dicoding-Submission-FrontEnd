class DataItemWeapon extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    this.shadowDOM.innerHTML = `
        ...
        <img class="object-cover cursor-pointer img" width="150" src="${this._data.img}">
    ...
    this.shadowDOM.querySelector('.img').addEventListener('click', (e) => {
      ...
      window.location.href = `/detailWeapon.html?id=${getId}`;
    });
  }
}

customElements.define('data-item-weapon', DataItemWeapon);
